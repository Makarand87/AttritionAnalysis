...
dataa <- rbind(active, inactive); nrow(dataa)
# str(data)
AR <- subset(dataa, data$VerticalName == "Accounts Receivable");nrow(AR) # 4409
...
with(dataset2[dataset2$TotalExtraHoursWorked==0,],table(Status))
with(dataset2[dataset2$TotalExtraHoursWorked>0,],table(Status))
################ Graphical ##################
...
dataset2 <- Current[c("EmployeeCode", "AGSExperienceInMonths", "EmployeeAge", "Gender", "MaritalStatus",  "WorkLocation" 
                      , "ExperienceType", "ProdAvgLast3Months", "QualAvgLast3Months", "CourseLevels", "Last30DaysLeaveCount",
                      "TotalExtraHoursWorked", "Shift3", "TransportMode","EngagementIndex", "FunctionName", "Status", "Attrition", "Available")]
...
logit1 <- glm(Attrition ~  EngagementIndex + AGSExperienceInMonths  + QualAvgLast3Months  + ProdAvgLast3Months
...
# table(Current$Status, Current$EngagementIndex)
# table(Current$Status, Current$CourseLevels)
# table(Current$Status, Current$FunctionName)
# table(Current$Status, Current$Gender)
# table(Current$Status, Current$TransportMode)
# table(Current$Status, Current$Shift3)
# table(Current$Status, Current$WorkLocation)
# table(Current$Status, Current$ExperienceType)
# table(Current$Status, Current$MaritalStatus)
# table(Current$Status, Current$EngagementIndex)
# table(Current$Status, Current$EngagementIndex)
# boxplot(Current$AGSExperienceInMonths ~ Current$Status)
# boxplot(Current$QualAvgLast3Months ~ Current$Status)
# boxplot(Current$ProdAvgLast3Months ~ Current$Status)
# boxplot(Current$EmployeeAge ~ Current$Status)
# boxplot(Current$TotalExtraHoursWorked ~ Current$Status)
